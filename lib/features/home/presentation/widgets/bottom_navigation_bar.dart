...
class CustomeBottomNavigationBar extends StatefulWidget {
  const CustomeBottomNavigationBar({super.key, required this.selectedIndex, required this.onItemSelected});
 final int selectedIndex; 
final ValueChanged<int> onItemSelected;
  @override
  State<CustomeBottomNavigationBar> createState() => _CustomeBottomNavigationBarState();
}
